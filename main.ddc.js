define(['dart_sdk', 'packages/flutter_web_ui/ui', 'packages/PDesireFlutterPage/main'], function(dart_sdk, packages__flutter_web_ui__ui, packages__PDesireFlutterPage__main) {
  'use strict';
  ...
  const main = packages__PDesireFlutterPage__main.main;
